    ...
    >
        ...
        <div>
            ...
            <textarea
              ...
              className="w-full min-h-[140px] rounded-[0.5rem] bg-richblack-700 p-[12px] text-richblack-5"
                />
            {
                errors.courseShortDesc && (<span className="text-pink-200">
        ...
        <div className='relative'>
            ...
            <input
              ...
              className="w-full rounded-[0.5rem] bg-richblack-700 p-[12px] text-richblack-5"
            />
            <HiOutlineCurrencyRupee  className='absolute top-4 text-richblack-400'/>
            {
                errors.coursePrice && (
        ...
        <div className='flex justify-end'>
            ...
            <IconButton
                ...
                customClasses={"mt-6 rounded-[8px] bg-yellow-50 py-[8px] px-[16px] font-semibold text-richblack-900"}
                />
        </div>
    </form>
  )
