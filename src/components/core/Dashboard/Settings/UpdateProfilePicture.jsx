...
import { updatedDisplayPicture } from "../../../../services/operations/SettingsAPI";
...
export default function UpdateProfilePicture() {
  ...
  const handleFileUpload = () => {
    try {
      ...
      dispatch(updatedDisplayPicture(token, formData , navigate)).then(() => {
        setLoading(false);
      });
    } catch (error) {
          ...
          <p className="max-[600px]:text-center">Change Profile Picture</p>
            <div className="flex flex-row gap-3">
              ...
              <IconBtn
                ...
                customClasses={"cursor-pointer flex flex-row-reverse items-center gap-x-2 rounded-md bg-yellow-50 py-2 px-5 font-semibold text-richblack-900"}
              >
                {!loading && (
