...
const CourseInformationForm = () => {
  ...
  useEffect(() => {
    ...
    //   console.log("COURSE_TREQUIREMENTS : " , course.instructions)
    ...
    >
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-[0.5rem] bg-richblack-700 p-[12px]  text-richblack-5"
        />
        <HiOutlineCurrencyRupee className="absolute left-3 top-12 inline-block -translate-y-1/2 text-2xl text-richblack-400"/>
        {errors.coursePrice && (
      ...
      <div className="flex justify-end gap-x-4 ">
        {editCourse && (
          <button
            ...
            className="mt-6 rounded-[8px] bg-richblack-700 py-3 px-6 font-semibold text-richblack-50"
          >
        ...
        <IconButton
          ...
          customClasses={
            "mt-6 rounded-[8px] bg-yellow-50 py-3 px-6 font-semibold text-richblack-900"
          }
        />
      </div>
    </form>
