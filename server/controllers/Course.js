...
exports.createCourse = async(req,res) => {
    try {
        //fetch data
        let {courseName,courseDescription , whatYouWillLearn,price,category,status,instructions,tag} = req.body;//tag => is representing the id 
        ...
        const cloudinaryResponse = await uploadImageToCloudinary(thumbnail,process.env.FOLDER_NAME);
